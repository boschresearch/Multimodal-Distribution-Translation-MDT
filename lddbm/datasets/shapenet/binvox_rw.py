...
def dense_to_sparse(voxel_data, dtype):
...
def write(voxel_model, fp):
    ...
    """
    if voxel_model.train_data.ndim == 2:
        dense_voxel_data = sparse_to_dense(voxel_model.train_data, voxel_model.dims)
    else:
        dense_voxel_data = voxel_model.train_data
