...
def load_arguments(parser) -> None:
    ...
    parser.add_argument(
        "--distance_measure_loss", type=str, default=DistanceMetric.MSE.value
    )
    parser.add_argument(
        "--clip_loss_w",
        type=float,
    ...
    parser.add_argument(
        "--encoder_x_type", type=str, default=Encoders.Conv3DEncoder.value
    )
    parser.add_argument("--decoder_x_path", type=str, default="tmp_decoder_x")
    parser.add_argument(
        "--decoder_x_type", type=str, default=Decoders.Conv3DDecoder.value
    )
    # model
    ...
    parser.add_argument(
        "--encoder_y_type", type=str, default=Encoders.MV2DEncoder.value
    )
