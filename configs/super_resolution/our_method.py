...
def load_arguments(parser) -> None:
    ...
    parser.add_argument('--distance_measure_loss', type=str, default=DistanceMetric.LPIPS.value)
    ...
    parser.add_argument('--encoder_x_type', type=str, default=Encoders.KlVaePreTrainedEncoder128.value)
    parser.add_argument('--decoder_x_path', type=str, default="tmp_decoder_x")
    parser.add_argument('--decoder_x_type', type=str, default=Decoders.KlVaePreTrainedDecoder128.value)
    # model
    ...
    parser.add_argument('--encoder_y_type', type=str, default=Encoders.KlVaePreTrainedEncoder16.value)
